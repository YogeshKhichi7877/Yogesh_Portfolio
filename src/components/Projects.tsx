...
// //     )
// //     .fromTo(filterRef.current ? Array.from(filterRef.current.children) : [],
// //       { y: 30, opacity: 0 },
// //       { y: 0, opacity: 1, duration: 0.6, stagger: 0.1, ease: "power3.out" },
// //       "-=0.6"
// //     )
// //     .fromTo(projectsRef.current ? Array.from(projectsRef.current.children) : [],
// //       { y: 60, opacity: 0 },
...
//       category: "Full-Stack",
//       github: "https://github.com/YogeshKhichi7877/Ecommerce_web.git",
...
//       category: "Full-Stack",
//       github: "https://github.com/YogeshKhichi7877/Signup_app.git",
...
//       category: "AI",
//       github: "https://github.com/YogeshKhichi7877/AI-Model.git",
...
//       description: "Secure mobile banking app with biometric authentication, real-time transactions, and comprehensive financial tools.",
//       longDescription: "Cross-platform mobile banking solution featuring end-to-end encryption, biometric security, real-time notifications, budget tracking, investment management, and 24/7 customer support.",
...
//       ],
//       tech: ["React Native", "Node.js", "MongoDB", "JWT", "Stripe", "AWS"],
//       category: "Mobile",
//       github: "#",
//       live: "#",
//       featured: false,
...
//       description: "Virtual reality web platform for immersive experiences using WebXR technologies and spatial computing.",
//       longDescription: "Cutting-edge VR platform built for the web using WebXR APIs, featuring immersive 3D environments, spatial audio, hand tracking, cross-platform compatibility, and content management system.",
...
//     gsap.fromTo(projectsRef.current ? Array.from(projectsRef.current.children) : [],
//       { y: 30, opacity: 0 },
//       { y: 0, opacity: 1, duration: 0.6, stagger: 0.1, ease: "power3.out" }
//     );
//   };
...
//                 <div className="project-overlay absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 transition-opacity duration-300">
//                   <div className="absolute bottom-4 left-4 right-4">
//                     <div className="flex gap-2 mb-3">
//                       <span className="px-3 py-1 bg-green-500/80 backdrop-blur-sm rounded-full text-white text-xs font-medium flex items-center gap-1">
//                         <div className="w-2 h-2 bg-green-300 rounded-full animate-pulse"></div>
//                         {project.status}
//                       </span>
//                       <span className="px-3 py-1 bg-blue-500/80 backdrop-blur-sm rounded-full text-white text-xs font-medium flex items-center gap-1">
//                         <Calendar className="w-3 h-3" />
//                         {project.duration}
//                       </span>
//                       <span className="px-3 py-1 bg-purple-500/80 backdrop-blur-sm rounded-full text-white text-xs font-medium flex items-center gap-1">
...
//               <div className="p-8">
//                 <h3 className="project-title text-2xl font-bold text-white mb-4 transition-colors duration-300">{project.title}</h3>
//                 <p className="text-gray-400 mb-4 leading-relaxed">{project.description}</p>
                
//                 {project.featured && (
//                   <p className="text-gray-500 mb-6 text-sm leading-relaxed">{project.longDescription}</p>
//                 )}
...
//                         />
//                         <div className="absolute inset-0 bg-black/20 opacity-0 group-hover/img:opacity-100 transition-opacity duration-300"></div>
//                       </div>
//                     ))}
//                   </div>
//                 )}
...
//             <polygon points="25,0 43.3,12.5 43.3,37.5 25,50 6.7,37.5 6.7,12.5" fill="none" stroke="currentColor" strokeWidth="1"/>
//           </pattern>
//         </defs>
...
// Sample projects; swap out with your actual projects array
const projects = [
      {
      title: "E-Commerce Platform",
      description: "Modern e-commerce solution , real-time inventory management, and advanced analytics dashboard.Includes advanced security features and user authentication.",
