...
// const serviceIcons = [Code2, LayoutDashboard, Cuboid, Box, Bot, Users];
...
//       eyebrow="Services"
//       title="Ways I can help turn ideas into polished web products."
//       description="A focused set of practical services for founders, students, teams, and personal brands that need clean engineering with a creative edge."
//     >
...
//             <GlassCard
//               key={service.title}
//               className="group flex h-full flex-col p-5 transition duration-300 hover:-translate-y-1 hover:border-os-cyan/40"
//             >
//               <div className="mb-5 flex items-start justify-between gap-4">
//                 <div className="grid h-12 w-12 place-items-center rounded-2xl border border-os-line bg-os-cyan/10 text-os-cyan transition group-hover:border-os-cyan/50 group-hover:bg-os-cyan/15">
...
//               <h3 className="font-display text-xl font-bold tracking-tight text-os-text">
//                 {service.title}
//               </h3>
//               <p className="mt-3 text-sm leading-6 text-os-muted">{service.summary}</p>

//               <div className="mt-5 grid gap-2">
//                 {service.deliverables.map((deliverable) => (
//                   <div key={deliverable} className="flex gap-2 text-sm text-os-muted">
...
//                     Good fit
//                   </p>
//                   <p className="mt-2 text-sm leading-6 text-os-muted">{service.fit}</p>
//                 </div>
//               </div>
//             </GlassCard>
//           );
...
//       <GlassCard intensity="strong" className="mt-8 p-5 sm:p-6">
//         <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
//           <div>
//             <p className="font-display text-xl font-bold text-os-text">
//               Need a build that mixes product logic, premium UI, and creative detail?
//             </p>
//             <p className="mt-2 text-sm leading-6 text-os-muted">
//               Share the idea, timeline, and must-have features. I can help shape it into a practical execution plan.
//             </p>
//           </div>
//           <Button
//             href="#contact"
